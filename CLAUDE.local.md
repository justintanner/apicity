...
**YOU ARE IN: `nakedapi/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/nakedapi/` (rig root) or other directories
...
**Your mail address:** `nakedapi/polecats/obsidian`
**Your rig:** nakedapi
**Your Witness:** `nakedapi/witness`
...
| Ask Witness for help  | `gt mail send nakedapi/witness -s "HELP" -m "..."` | ~~gt nudge witness~~                        |

---

## When to Ask for Help

Mail your Witness (`nakedapi/witness`) when:
...
```bash
gt mail send nakedapi/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
