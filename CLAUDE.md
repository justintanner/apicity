...
pnpm run dev:preflight:fast -- <name-or-path> # fast provider gate: scoped format/lint, whole tests-project typecheck, provider typecheck/tests, cross-cutting recording tests
