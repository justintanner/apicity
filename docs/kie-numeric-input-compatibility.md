...
| wan/2-2-a14b-speech-to-video-turbo        | input.seed                    | optional; integer min=0 max=2147483647                                                               | DOC-80 @ 2026-08-07 | integer                                     | absent              | none beyond current OpenAPI                 | number-only         | medium     | enforce integer range; do not inject default |
...
| wan/2-5-image-to-video                    | input.seed                    | optional; integer min=0 max=2147483647                                                               | DOC-82 @ 2026-08-07 | integer                                     | number (123456)     | none beyond current OpenAPI                 | number-only         | high       | enforce integer range; do not inject default |
...
| wan/2-5-text-to-video                     | input.seed                    | optional; integer min=0 max=2147483647                                                               | DOC-83 @ 2026-08-07 | integer                                     | number (123456)     | none beyond current OpenAPI                 | number-only         | high       | enforce integer range; do not inject default |
