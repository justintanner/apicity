...
| bytedance/seedance-2-mini                 | input.duration                | optional; integer min=4 max=15 default=5                                                             | DOC-12 @ 2026-07-31 | integer default=5                           | number (15)         | default discrepancy resolved; ac-07mm6l     | number-only         | high       | align with official default contract     |
