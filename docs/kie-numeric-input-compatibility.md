...
| DOC-79 | https://docs.kie.ai/market/wan/2-6-flash-image-to-video.md              | `84b56e72233e04f3871d932077a01fb2a82ef0bbca8f5cc75c0f34b4047fe69e` |
| DOC-80 | https://docs.kie.ai/market/wan/2-6-flash-video-to-video.md              | `e2dc767be6f22010d4ca80405a2d5aee8eb8d126458974ca6f5f3198959b3260` |
| DOC-81 | https://docs.kie.ai/market/wan/2-6-image-to-video.md                    | `607e681278281decce3f723a86cb6454caf991d7888cc31b30f5aaef1f0c45b3` |
| DOC-82 | https://docs.kie.ai/market/wan/2-6-text-to-video.md                     | `809814bddd24bdd21cb3a00a91fa961fb489157203a3a609cab4b9f5076962f1` |
| DOC-83 | https://docs.kie.ai/market/wan/2-6-video-to-video.md                    | `88a8993e73ed8b97e1689e8b5d2a0b0ddc011010bed1a32ee388637136cf76a2` |
...
| wan/2-6-flash-image-to-video              | input.duration                | optional; numeric-string enum="5","10","15" default="5"                                              | DOC-79 @ 2026-08-07 | string enum="5","10","15" default="5"       | string ("5")        | none beyond current OpenAPI                 | numeric-string-only | high       | retain exact strings; reject numbers         |
| wan/2-6-flash-video-to-video              | input.duration                | optional; numeric-string enum="5","10" default="5"                                                   | DOC-80 @ 2026-08-07 | string enum="5","10" default="5"            | string ("5")        | none beyond current OpenAPI                 | numeric-string-only | high       | retain exact strings; reject numbers         |
| wan/2-6-image-to-video                    | input.duration                | optional; numeric-string enum="5","10","15" default="5"                                              | DOC-81 @ 2026-08-07 | string enum="5","10","15" default="5"       | string ("5")        | none beyond current OpenAPI                 | numeric-string-only | high       | retain exact strings; reject numbers         |
| wan/2-6-text-to-video                     | input.duration                | optional; numeric-string enum="5","10","15" default="5"                                              | DOC-82 @ 2026-08-07 | string enum="5","10","15" default="5"       | string ("5")        | none beyond current OpenAPI                 | numeric-string-only | high       | retain exact strings; reject numbers         |
| wan/2-6-video-to-video                    | input.duration                | optional; numeric-string enum="5","10" default="5"                                                   | DOC-83 @ 2026-08-07 | string enum="5","10" default="5"            | string ("5")        | none beyond current OpenAPI                 | numeric-string-only | high       | retain exact strings; reject numbers         |
