 ...
 * prohibitive.
 *
 * This module is additive and pure: it never mutates or re-shapes an estimate,
 * and it introduces no new dependencies.
 */
...
export function classifyEstimate(
  ...
  return classifyCostUsd((estimate as CostEstimate).usd);
}
