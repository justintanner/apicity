...
> = {
  ...
  kie: {
    ...
    // grok-imagine on kie has no audio toggle and no 1080p tier (only 480p
    // and 720p per the kie API docs). Rate below is xAI's direct $/s; kie's
    // passthrough markup and per-resolution tiers haven't been verified.
    "grok-imagine": { unit: "seconds", perUnit: 0.05 },
  },
};
