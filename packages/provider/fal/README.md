...
84 endpoints across 22 groups. Each method mirrors an upstream URL path.
...
[Upstream docs ↗](https://fal.ai/models/alibaba/qwen-image-3/edit/api)

```typescript
const res = await fal.run.alibaba.qwenImage3.edit({ /* ... */ });
```
