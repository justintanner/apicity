...
const EXAMPLES: Record<string, EndpointExample> = {
  ...
  "POST minimax.music3": {
    ...
    "payload": {
      "prompt": "Genre: acoustic pop. BPM: 96. Key: C major. Warm and intimate. Vocals: soft female lead. Arrangement: fingerpicked guitar and soft piano.",
  ...
  "POST topaz.upscale.image.precision": {
    "source": "fal/topaz-upscale-image-precision",
    "payload": {
