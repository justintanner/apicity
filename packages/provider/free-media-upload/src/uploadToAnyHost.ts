import { FreeMediaUploadError, type FreeMediaUploadProvider } from "./types";

export type FreeMediaUploadHost = "litterbox" | "uguu" | "tflink";

export interface UploadToAnyHostRequest {
  file: Blob;
  filename: string;
  hosts: FreeMediaUploadHost[];
  time?: "1h" | "12h" | "24h" | "72h";
}
