...
const EXAMPLES: Record<string, EndpointExample> = {
  "GET api.v1.aleph.recordInfo": {
    "source": "kie/aleph/generate-upstream-failure",
    "payload": {
      "taskId": "c0d088df35254cc3e7187fb7116b2efa"
    },
    "tier": "prohibitive",
    "runByDefault": false
  },
  ...
  "POST api.v1.aleph.generate": {
    ...
    "payload": {
      ...
      "videoUrl": "https://tempfile.redpandaai.co/kieai/136592/videos/test-uploads/1787093498568-wd60liaaio8.mp4",
      "uploadCn": false
    },
    "tier": "prohibitive",
    "runByDefault": false
  ...
  "POST api.v1.generate.generatePersona": {
    "source": "kie/suno/generate-persona-not-found",
    "payload": {
      "taskId": "apicity-test-nonexistent-task-id-do-not-record-real",
  ...
  "POST api.v1.veo.get4kVideo": {
    "source": "kie/veo/get-4k-video",
    "payload": {
      "taskId": "apicity-test-veo-4k-not-found",
      "index": 0
    },
    "tier": "prohibitive",
    "runByDefault": false
  ...
  "POST gemini35FlashOpenai.v1.chat.completions": {
    "source": "kie/gemini-35-flash-openai-chat-auth-error",
    "payload": {
      "messages": [
        {
          "role": "user",
