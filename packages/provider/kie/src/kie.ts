...
import { createGemini38FlashOpenaiProvider } from "./gemini-38-flash-openai";
...
export const CREATE_TASK_GUARDS = {
  ...
  "kling/v2-5-turbo-text-to-video-pro":
    KlingV25TurboTextToVideoProRequestSchema,
  "kling-3.0-omni/text-to-video": KlingOmniTextToVideoRequestSchema,
  "kling-3.0-omni/image-to-video": KlingOmniImageToVideoRequestSchema,
  "kling-3.0-omni/reference-to-video": KlingOmniReferenceToVideoRequestSchema,
  "kling-3.0-omni/transformation": KlingOmniTransformationRequestSchema,
  ...
  "gpt-image-2-5-flare-image-to-image":
    GptImage25FlareImageToImageRequestSchema,
  "gpt-image-2-5-flare-text-to-image": GptImage25FlareTextToImageRequestSchema,
  ...
  "qwen3/image-to-image": Qwen3ImageToImageRequestSchema,
  "qwen3/pro-text-to-image": Qwen3ProTextToImageRequestSchema,
  "qwen3/pro-image-to-image": Qwen3ProImageToImageRequestSchema,
  ...
  "bytedance/seedance-2-5": Seedance25RequestSchema,
  ...
  "wan/3-0-video": Wan30VideoRequestSchema,
  "wan/3-0-video-prime": Wan30VideoPrimeRequestSchema,
  ...
  "wan/2-2-a14b-image-to-video-turbo": Wan22A14bImageToVideoTurboRequestSchema,
  "wan/2-2-a14b-speech-to-video-turbo":
    Wan22A14bSpeechToVideoTurboRequestSchema,
  "wan/2-2-a14b-text-to-video-turbo": Wan22A14bTextToVideoTurboRequestSchema,
  "wan/2-2-animate-move": Wan22AnimateMoveRequestSchema,
  "wan/2-2-animate-replace": Wan22AnimateReplaceRequestSchema,
  "wan/2-5-image-to-video": Wan25ImageToVideoRequestSchema,
  "wan/2-5-text-to-video": Wan25TextToVideoRequestSchema,
  ...
  "google/gemini-omni-flash-1-1": GoogleGeminiOmniFlash11RequestSchema,
