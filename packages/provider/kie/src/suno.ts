...
import {
  SunoAddInstrumentalRequestSchema,
  SunoAddVocalsRequestSchema,
  SunoBoostStyleRequestSchema,
  SunoCoverGenerateRequestSchema,
  SunoCoverRecordInfoRequestSchema,
  SunoCoverRecordInfoResponseSchema,
  SunoExtendRequestSchema,
  SunoGeneratePersonaRequestSchema,
  SunoGeneratePersonaResponseSchema,
  SunoGenerateRequestSchema,
  SunoGetTimestampedLyricsRequestSchema,
  SunoGetTimestampedLyricsResponseSchema,
  SunoLyricsRecordInfoRequestSchema,
  SunoLyricsRecordInfoResponseSchema,
  SunoLyricsRequestSchema,
  SunoMashupRequestSchema,
  SunoMidiRecordInfoRequestSchema,
  SunoMidiRecordInfoResponseSchema,
  SunoMidiRequestSchema,
  ...
  SunoUploadExtendRequestSchema,
  SunoVocalRemovalRecordInfoRequestSchema,
  SunoVocalRemovalRecordInfoResponseSchema,
  SunoVocalRemovalRequestSchema,
  SunoVoiceCheckVoiceRequestSchema,
  SunoVoiceCheckVoiceResponseSchema,
  SunoVoiceGenerateRequestSchema,
  SunoVoiceRecordInfoRequestSchema,
  SunoVoiceRecordInfoResponseSchema,
  SunoVoiceRegenerateRequestSchema,
  SunoVoiceRegenerateResponseSchema,
  SunoVoiceValidateInfoRequestSchema,
  SunoVoiceValidateInfoResponseSchema,
  SunoVoiceValidateRequestSchema,
  SunoVoiceValidateResponseSchema,
  SunoWavRecordInfoRequestSchema,
  SunoWavRecordInfoResponseSchema,
  SunoWavRequestSchema,
} from "./zod";
...
export interface SunoGenerateRequest {
  ...
  // request schemas now live in zod.ts alongside it and likewise union
  // SunoModelAliasSchema, so their `model` accepts the same version aliases.
