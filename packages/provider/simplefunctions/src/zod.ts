...
// shipping new members and no id grammar an alias regex could match.
// .claude/CLAUDE.md names this schema by name as a counterexample to that rule,
// alongside `quality`, `vad_model` and `apply_text_normalization`. A new tier
// here is an upstream API change, and is added to this enum explicitly.
