...
// --- test side: recordingExists() name arguments ----------------------------

// Stays local: this is the reverse-direction (orphan/phantom) scanner and
// nothing else needs it. The shared `setupPolly*` half lives in
// scripts/lib/recording-names.mjs.
