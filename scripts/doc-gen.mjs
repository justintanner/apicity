...
function renderKieExample() {
  return [
    ...
    "default to empty arrays when using the exported Zod schema. The example",
    "selects the valid upper-bound override `duration: 15`; omitting `duration`",
    "uses the schema default of `5`. Duration is an integer from 4 to 15",
    "seconds, `resolution` is `480p` or `720p`,",
