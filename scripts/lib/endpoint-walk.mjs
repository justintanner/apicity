...
const PROVIDERS = [
  ...
  {
    name: "zaicoding",
    entryFiles: ["packages/provider/zaicoding/src/zaicoding.ts"],
    factoryNames: ["createZaiCoding"],
  },
  {
    name: "google",
  ...
  },
  {
    ...
    entryFiles: [
      ...
      "packages/provider/kie/src/gemini.ts",
      "packages/provider/kie/src/responses.ts",
      "packages/provider/kie/src/gemini-31-pro.ts",
      "packages/provider/kie/src/gemini-25-flash.ts",
      "packages/provider/kie/src/gemini-3-flash.ts",
      "packages/provider/kie/src/gemini-35-flash-openai.ts",
      "packages/provider/kie/src/gemini-36-flash-openai.ts",
      "packages/provider/kie/src/gemini-37-flash-openai.ts",
      "packages/provider/kie/src/gemini-38-flash-openai.ts",
      "packages/provider/kie/src/gemini-3-pro.ts",
    ...
    factoryNames: [
      ...
      "createGemini31ProProvider",
      "createGemini25FlashProvider",
      "createGemini3FlashProvider",
      "createGemini35FlashOpenaiProvider",
      "createGemini36FlashOpenaiProvider",
      "createGemini37FlashOpenaiProvider",
      "createGemini38FlashOpenaiProvider",
      "createGemini3ProProvider",
  ...
  },
  {
    name: "elevenlabs",
    entryFiles: [
      "packages/provider/elevenlabs/src/elevenlabs.ts",
      "packages/provider/elevenlabs/src/transport.ts",
      "packages/provider/elevenlabs/src/pronunciation-dictionaries.ts",
      "packages/provider/elevenlabs/src/models.ts",
      "packages/provider/elevenlabs/src/voices.ts",
      "packages/provider/elevenlabs/src/audio.ts",
      "packages/provider/elevenlabs/src/speech-to-text.ts",
      "packages/provider/elevenlabs/src/music.ts",
      "packages/provider/elevenlabs/src/speech-engine.ts",
      "packages/provider/elevenlabs/src/productions.ts",
      "packages/provider/elevenlabs/src/text-to-speech.ts",
      "packages/provider/elevenlabs/src/dubbing.ts",
      "packages/provider/elevenlabs/src/studio.ts",
      "packages/provider/elevenlabs/src/speech-to-speech.ts",
      "packages/provider/elevenlabs/src/user.ts",
      "packages/provider/elevenlabs/src/workspace.ts",
      "packages/provider/elevenlabs/src/service-accounts.ts",
      "packages/provider/elevenlabs/src/convai.ts",
      "packages/provider/elevenlabs/src/history.ts",
    ],
    factoryNames: [
      "createElevenLabs",
      "createPronunciationDictionariesEndpoints",
      "createModelsEndpoints",
      "createVoicesEndpoints",
      "createAudioEndpoints",
      "createSpeechToTextEndpoints",
      "createMusicEndpoints",
      "createSpeechEngineEndpoints",
      "createProductionsEndpoints",
      "createTextToSpeechEndpoints",
      "createDubbingEndpoints",
      "createStudioEndpoints",
      "createSpeechToSpeechEndpoints",
      "createUserEndpoints",
      "createWorkspaceEndpoints",
      "createServiceAccountsEndpoints",
      "createConvaiEndpoints",
      "createHistoryEndpoints",
    ],
  },
  {
    name: "x",
...
export const STREAM_KEYS = new Set(["stream", "ws", "run"]);
