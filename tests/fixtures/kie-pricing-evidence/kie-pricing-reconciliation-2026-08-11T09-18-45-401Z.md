...
| -------------------------------- | -------: | ----: | -------------------------------- |
| Schema model IDs                 |      127 |   134 | descriptors 134; guards 134      |
| Documented endpoints             |       71 |    71 | 53 POST; 18 GET                  |
| Runtime pricing keys             |      135 |   140 | current Kie table                |
...
| Slug keys                        |      137 |   142 | Kie model metadata               |
| Display keys                     |      137 |   142 | Kie model metadata               |
...
| `grok-imagine-image-2-0/text-to-image` | upstream-unmappable | The final WI6 inventory records the model without a current runtime pricing key as an explicit audit membership. | none      |
...
| `grok-imagine-image-2-0/image-edit`    | upstream-unmappable | The final WI6 inventory records the model without a current runtime pricing key as an explicit audit membership. | none      |
...
Every live Kie per-unit rate variant is covered by an executable official case or one of **16** explicit exceptions below. Zero-rate Grok and Topaz entries are unreachable sentinels, not free variants.
...
| `grok-imagine-image-2-0/text-to-image | `      | pricing-only | tests/recordings/kie_2079838932/grok-imagine-image-2-lifecycle_1692809741/recording.har terminal recordInfo reports 4.0 credits and exactly one result URL                                        | The reachable $0.02 per generation variant is supported by live billing evidence but postdates the frozen 2026-08-11 pricing snapshot.                                 |
| `grok-imagine-image-2-0/segment-map   | `      | pricing-only | tests/recordings/kie_2079838932/grok-imagine-image-2-lifecycle_1692809741/recording.har terminal recordInfo reports 0.0 credits                                                                   | The reachable $0.00 per generation variant is supported by live billing evidence but postdates the frozen 2026-08-11 pricing snapshot.                                 |
| `grok-imagine-image-2-0/image-edit    | `      | pricing-only | tests/recordings/kie_2079838932/grok-imagine-image-2-lifecycle_1692809741/recording.har terminal recordInfo reports 4.0 credits                                                                   | The reachable $0.02 per generation variant is supported by live billing evidence but postdates the frozen 2026-08-11 pricing snapshot.                                 |
...
| `bytedance/seedance-2-5               | 1080p  | audio`       | pricing-only                                                                                                                                                                                      | plans/ac-ojfoj9/build/seedance-2-5-pricing-check-2026-08-19.json records the official 2026-08-19 pricing verification                                                  | This runtime variant is a post-snapshot addition verified against official pricing on 2026-08-19.                       |
| `bytedance/seedance-2-5               | 1080p  | no-audio`    | pricing-only                                                                                                                                                                                      | plans/ac-ojfoj9/build/seedance-2-5-pricing-check-2026-08-19.json records the official 2026-08-19 pricing verification                                                  | This runtime variant is a post-snapshot addition verified against official pricing on 2026-08-19.                       |
