...
| Documented endpoints             |       71 |    72 | 54 POST; 18 GET                  |
...
Every live Kie per-unit rate variant is covered by an executable official case or one of **14** explicit exceptions below. Zero-rate Grok and Topaz entries are unreachable sentinels, not free variants.
