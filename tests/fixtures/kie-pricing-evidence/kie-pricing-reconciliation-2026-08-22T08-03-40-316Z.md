...
| Runtime pricing keys             |      135 |   148 | current Kie table                |
...
| Slug keys                        |      137 |   150 | Kie model metadata               |
| Display keys                     |      137 |   150 | Kie model metadata               |
...
Every live Kie per-unit rate variant is covered by an executable official case or one of **36** explicit exceptions below. Zero-rate Grok and Topaz entries are unreachable sentinels, not free variants.
