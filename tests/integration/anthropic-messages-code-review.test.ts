...
// Translates the Anthropic `x-api-key` header into the Bearer-token form that
// a Claude-compatible gateway (here: kie.ai) expects. Lets the typed
// @apicity/anthropic SDK exercise a recordable backend without baking an
// anthropic.com key into CI.
