...
describe("kie kling-3.0-omni/image-to-video integration", () => {
  ...
  it(
    "uploads a first frame, creates a task, and polls to a successful media result",
    { timeout: 900_000 },
    async () => {
      ctx = setupPollyForFileUploads("kie/kling-30-omni-image-to-video");
      ...
      const request = {
        ...
        input: {
          prompt:
            "The white cat looks toward the camera, blinks slowly, and gently tilts its head.",
          image_urls: [cat1Url],
          resolution: "720p",
          duration: 5,
          audio: false,
