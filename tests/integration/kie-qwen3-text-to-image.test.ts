...
describe("kie qwen3/text-to-image integration", () => {
  ...
  it(
    ...
    { timeout: 600_000 },
    async () => {
      ctx = setupPolly("kie/qwen3-text-to-image");
      ...
      const request = {
        ...
        input: {
          prompt:
            "A cinematic editorial photograph of a red fox in a snowy pine forest at blue hour.",
          resolution: "1K",
          image_size: "16:9",
          output_format: "png",
          prompt_extend: false,
