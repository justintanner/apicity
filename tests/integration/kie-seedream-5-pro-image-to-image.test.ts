...
describe("kie seedream/5-pro-image-to-image integration", () => {
  ...
  it(
    ...
    { timeout: 600_000 },
    async () => {
      ctx = setupPolly("kie/seedream-5-pro-image-to-image");
      ...
      const request = {
        ...
        input: {
          prompt:
            "Keep the model's pose and the flowing shape of the liquid dress unchanged. Change the clothing material from silver metal to completely transparent clear water.",
          image_urls: [
