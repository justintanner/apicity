...
const RECORDING_NAME = "kie/suno/vocal-removal-record-info-not-found";
const MISSING_TASK_ID = "apicity-test-nonexistent-task-id-do-not-record-real";

describe("kie suno vocal-removal record-info (not found)", () => {
  ...
  it("returns the null-data success envelope for a missing task", async () => {
    ...
    const recordInfo = provider.suno.get.api.v1.vocalRemoval.recordInfo;
