// Tests for DoltHub middleware functions — pure HOFs, no API calls
// Tests withRetry and withFallback from the DoltHub provider middleware
import { describe, it, expect } from "vitest";
import {
  withRetry,
  withFallback,
} from "../../packages/provider/dolthub/src/middleware";
